            ...
            {navItems.map((group) => {
              ...
              return (
                <div key={group.label || group.to} className="relative group">
                  <div
                    className={`px-3 py-2 rounded-md text-sm font-semibold flex items-center gap-2 transition-colors cursor-pointer ${
                      isParentActive
                    ...
                    <div className="absolute left-0 top-full mt-[0px] hidden group-hover:block bg-white shadow-lg rounded-md p-2 z-50">
                      {group.children.map((item) => (
                        <NavLink
                          ...
                          className={({ isActive }) =>
                            `block px-3 py-2 rounded-md text-sm font-semibold flex items-center gap-2 transition-colors ${
                              isActive
                                ? "bg-[#2D4C3B] text-[#F5F4F0]"
                                : "text-[#1C1F1D] hover:bg-[#E8E5DC]"
                            }`
          ...
          <div className="flex gap-1 px-2 py-2 min-w-max">
            {navItems.map((n) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `px-3 py-1.5 rounded-md text-xs font-semibold whitespace-nowrap flex items-center gap-1.5 ${
                    isActive ? "bg-[#2D4C3B] text-[#F5F4F0]" : "text-[#1C1F1D] bg-[#E8E5DC]"
                  }`
                }
              >
